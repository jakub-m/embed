...
static ledTaskParameters_t ledParams1 = { ledPin: GPIO_Pin_15, tick:10000
  ...
  xTaskCreate (vLEDFlashTask, "LED1", ledSTACK_SIZE, (void *) &ledParams1,
	       ledPRIORITY, (TaskHandle_t *) NULL);

static ledTaskParameters_t ledParams2 = { ledPin: GPIO_Pin_14, tick:7500 };
  xTaskCreate (vLEDFlashTask, "LED2", ledSTACK_SIZE, (void *) &ledParams2,
	       ledPRIORITY, (TaskHandle_t *) NULL);

static ledTaskParameters_t ledParams3 = { ledPin: GPIO_Pin_13, tick:5000 };
  xTaskCreate (vLEDFlashTask, "LED3", ledSTACK_SIZE, (void *) &ledParams3,
	       ledPRIORITY, (TaskHandle_t *) NULL);

static ledTaskParameters_t ledParams4 = { ledPin: GPIO_Pin_12, tick:2500 };
  xTaskCreate (vLEDFlashTask, "LED4", ledSTACK_SIZE, (void *) &ledParams4,
	       ledPRIORITY, (TaskHandle_t *) NULL);
...
static void
vLEDFlashTask (void *pvParameters)
{
